...
// const int pumpPin = PB8;  // Pump 2
// const int sensorPin = PA1; // Sensor for Pump 2

// // Calibration factors [0-50mL, 51-100mL, 101-150mL, 151-1000mL]
// float calibrationFactors[4] = {1.9, 1.9, 1.9, 1.9}; // Initial values
...
//   Serial.print("⚙️ Pump 2 ON - Target: ");
//   Serial.print(volume);
//   Serial.print(" mL | Cal: ");
...
//   Serial.println("✅ Pump 2 Test System Ready");
//   Serial.println("📘 Commands:");
//   Serial.println("  D2:<volume>       - Dispense volume (mL)");
//   Serial.println("  D2:<v>:<cal>@<r> - Set cal & dispense (e.g. D2:100:11.5@1)");
