...
// const int pumpPin = PB6;  // Pump 4
// const int sensorPin = PA3; // Sensor for Pump 4

// // Calibration factors [0-50mL, 51-100mL, 101-150mL, 151-1000mL]
// float calibrationFactors[4] = {3, 8.7, 10, 10}; // Initial values
...
//   Serial.print("⚙️ Pump 4 ON - Target: ");
//   Serial.print(volume);
//   Serial.print(" mL | Cal: ");
...
//   Serial.println("✅ Pump 4 Test System Ready");
//   Serial.println("📘 Commands:");
//   Serial.println("  D4:<volume>       - Dispense volume (mL)");
//   Serial.println("  D4:<v>:<cal>@<r> - Set cal & dispense (e.g. D4:100:11.5@1)");
